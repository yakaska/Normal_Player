...
public class NowPlayingMetadata {
    ...
    public NowPlayingMetadata(String mediaId, Uri albumArtUri, String title, String subtitle, String duration) {
    ...
    public static String timestampToMSS(Context context, long position) {
        ...
        else return String.format(context.getString(R.string.duration_format), minutes, remainingSeconds);
    }
