...
public class QueueHelper {
    ...
    private static final int RANDOM_QUEUE_SIZE = 500;
...
//
    //    Log.d(TAG, "Creating playing queue for musics from search: " + query + " params=" + queryParams);
//
...
//
     ...
     */
    public static List<MediaMetadataCompat> getRandomQueue(MusicProvider musicProvider) {
