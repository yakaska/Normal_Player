...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public static final String ACTION_PAUSE = "ru.myitschool.normalplayer.pause";
    public static final String ACTION_PLAY = "ru.myitschool.normalplayer.play";
    public static final String ACTION_PREV = "ru.myitschool.normalplayer.prev";
    public static final String ACTION_NEXT = "ru.myitschool.normalplayer.next";
    public static final String ACTION_STOP_CASTING = "ru.myitschool.normalplayer.stop_cast";
    ...
    public MediaNotificationManager(PlaybackService service) throws RemoteException {
        Log.d(TAG, "MediaNotificationManager: create");
        mService = service;
        updateSessionToken();
    ...
    private Notification createNotification() {
        ...
        if ((mPlaybackState.getActions() & PlaybackStateCompat.ACTION_SKIP_TO_PREVIOUS) != 0) {
            notificationBuilder.addAction(R.drawable.ic_skip_previous_white_24,
        ...
        if ((mPlaybackState.getActions() & PlaybackStateCompat.ACTION_SKIP_TO_NEXT) != 0) {
            notificationBuilder.addAction(R.drawable.ic_skip_next_white_24,
                    mService.getString(R.string.next), mNextIntent);
        }
        ...
        intent.setAction(PlaybackService.ACTION_STOP_SERVICE);
        PendingIntent deleteIntent = PendingIntent.getService(mService.getApplicationContext(), 0, intent, 0);
        notificationBuilder.addAction(R.drawable.ic_clear_24, "Jopa", deleteIntent);
    ...
    private void addPlayPauseAction(NotificationCompat.Builder builder) {
        ...
        if (mPlaybackState.getState() == PlaybackStateCompat.STATE_PLAYING) {
            ...
            icon = R.drawable.ic_pause_white_24;
            intent = mPauseIntent;
        } else {
            label = mService.getString(R.string.play);
            icon = R.drawable.ic_play_arrow_white_24;
            intent = mPlayIntent;
        }
